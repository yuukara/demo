...
/** グローバル例外ハンドラー アプリケーション全体の例外処理とエラーレスポンスを統一的に管理します */
@RestControllerAdvice
public class GlobalExceptionHandler {

  private static final Logger log = LoggerFactory.getLogger(GlobalExceptionHandler.class);

  /** Bean Validation例外をハンドリングします @Valid アノテーションによる検証エラーの処理 */
  ...
  public ResponseEntity<Map<String, Object>> handleMethodArgumentNotValidException(
    ...
    log.warn("入力値検証エラー: 検証対象={}, エラー件数={}", targetClassName, fieldErrors.size());
  ...
  /** Service層での検証例外をハンドリングします @Validated アノテーションによる検証エラーの処理 */
