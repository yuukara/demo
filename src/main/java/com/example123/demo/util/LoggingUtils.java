...
/**
 * ログ出力の統一化と構造化を支援するユーティリティクラス
 * MDC（Mapped Diagnostic Context）を使用してコンテキスト情報を管理
 */
@Component
public class LoggingUtils {
    ...
    public static String logApiStart(Logger logger, String endpoint, Object params) {
        ...
        logger.info("API処理開始: {} - operationId: {}, params: {}", endpoint, operationId, sanitizeForLog(params));
        return operationId;
    }
     ...
     */
    public static void logDatabaseStart(Logger logger, String operation, String tableName, int recordCount) {
