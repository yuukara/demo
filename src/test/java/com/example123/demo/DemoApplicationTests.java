...
class DemoApplicationTests {
  ...
  @Autowired private OptimizedEmployeeService optimizedEmployeeService;
  ...
  void testEmployeeServicePerformance() throws IOException {
    ...
    log.info(
        "Data generation completed in {} seconds\n", String.format("%.2f", dataGenTime / 1000.0));
    ...
    log.info(
        "Original multi-threaded processing completed in {} seconds\n",
    ...
    log.info(
        "Optimized multi-threaded processing with sort completed in {} seconds\n",
    ...
    log.info(
        "Single-thread (unsorted):         {} seconds",
        String.format("%.2f", singleThreadTime / 1000.0));
    log.info(
        "Multi-thread (unsorted):          {} seconds",
        String.format("%.2f", multiThreadTime / 1000.0));
    log.info(
        "Multi-thread (external sort):     {} seconds",
        String.format("%.2f", optimizedTime / 1000.0));
